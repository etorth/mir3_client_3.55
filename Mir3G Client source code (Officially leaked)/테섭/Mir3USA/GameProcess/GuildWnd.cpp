...
#define GUILDWND_MAX_SHOWLINE		15
...
VOID CGuildWnd::Init()
{
	...
	ZeroMemory(&m_szTemp, sizeof(4096));
	m_nStep = 0;
}
...
VOID CGuildWnd::ShowGuildWnd()
{
	...
	// 공지사항
	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4010));

	rcBtn.left += 80;
	rcBtn.right += 80;

	// 문원목록
//	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4009));
	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4021));
	
	rcBtn.left += 198;
	rcBtn.right += 198;

	// 공지수정
//	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4011));
	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4022));
	
	rcBtn.left += 80;
	rcBtn.right += 80;

	// 문원삭제
//	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4012));
	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4023));
	...
	// 문파채팅
//	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4008));
	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4024));
	
	rcBtn.left += 278;
	rcBtn.right += 278;

	// 직위수정
//	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4014));
	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4025));
	
	rcBtn.left += 80;
	rcBtn.right += 80;

	// 동맹해제
//	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4015));
	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4026));
	
	rcBtn.left += 80;
	rcBtn.right += 80;

	// 문파해체
//	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4013));
	g_xMainWnd.PutsHan(NULL, rcBtn, RGB(255, 255, 0), RGB(0, 0, 0), g_xMsg.GetMsg(4027));
...
/*	if ( wPacket == CM_GUILDADDMEMBER && bMsgReturn == _BTN_YES )
	...
	else if ( wPacket == CM_GUILDBREAKALLY && bMsgReturn == _BTN_YES )
	{
		...
		g_xMainWnd.StringPlus(pszMessage, g_xMsg.GetMsg(4016), (CHAR*)lParam, "");
