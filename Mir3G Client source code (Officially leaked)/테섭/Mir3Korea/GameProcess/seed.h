...
#define BASE_ITER       2000


/*
#define BytePrint(FP, msg, DataSize, Data) {                  \
    DWORD idx;                                                \
    f//printf(FP, "%s\t", msg);                                 \
    for( idx=0; idx<(DWORD)DataSize; idx++) {                 \
        if( (idx!=0) && (idx%16==0) ) f//printf(FP, "\n\t\t");  \
        f//printf(FP, " %.2X", ((BYTE *)Data)[idx]);            \
    }                                                         \
    f//printf(FP, "\n");                                        \
}
*/
...
void SeedEncrypt 
    (BYTE *pbData, DWORD *pdwRoundKey);
void SeedDecrypt
    (BYTE *pbData, DWORD *pdwRoundKey);
void SeedEncRoundKey
    (DWORD *pdwRoundKey, BYTE *pbUserKey);
...
void SeedEncrypt(BYTE *pbData, DWORD *pdwRoundKey)
{
	...
	//printf("-- Round 0 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(L0, L1, R0, R1, K);
	//printf("-- Round 0 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(R0, R1, L0, L1, K+2);
	//printf("-- Round 1 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(L0, L1, R0, R1, K+4);
	//printf("-- Round 2 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(R0, R1, L0, L1, K+6);
	//printf("-- Round 3 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(L0, L1, R0, R1, K+8);
	//printf("-- Round 4 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(R0, R1, L0, L1, K+10);
	//printf("-- Round 5 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(L0, L1, R0, R1, K+12);
	//printf("-- Round 6 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(R0, R1, L0, L1, K+14);
	//printf("-- Round 7 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(L0, L1, R0, R1, K+16);
	//printf("-- Round 8 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(R0, R1, L0, L1, K+18);
	//printf("-- Round 9 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(L0, L1, R0, R1, K+20);
	//printf("-- Round 10 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(R0, R1, L0, L1, K+22);
	//printf("-- Round 11 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(L0, L1, R0, R1, K+24);
	//printf("-- Round 12 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(R0, R1, L0, L1, K+26);
	//printf("-- Round 13 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(L0, L1, R0, R1, K+28);
	//printf("-- Round 14 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	SeedRound(R0, R1, L0, L1, K+30);
	//printf("-- Round 15 : L0 : L1 : R0 : R1 : = %X, %X, %X, %X \n", L0, L1, R0, R1);
	...
	//printf("-Final Enc Result : L0 : L1 : R0 : R1 =	%X, %X, %X, %X \n", L0, L1, R0, R1);
}
...
void SeedEncRoundKey(DWORD *pdwRoundKey, BYTE *pdUserKey)
{
