...
*******************************************************************************************************************/
void SetBlendRenderState(LPDIRECT3DDEVICE7 pd3dDevice, BYTE bBlendFlag, D3DMATERIAL7* pmtrlGetMtrl)
{
	...
	{
	case 0:
		if ( pmtrlGetMtrl->diffuse.a < 1.0f || pmtrlGetMtrl->emissive.a < 1.0f ) 
		{
