...
public:
	VOID			OldImageSetNPCFrameInfo( WORD wMonNum );		// 코드 정리 by eriastoa 2006.04.19
	VOID			OldImageSetMonFrameInfo( WORD wMonNum );		// 코드 정리 by eriastoa 2006.04.19
	VOID			AddedImageSetMonFrameInfo( WORD wMonNum );
};
